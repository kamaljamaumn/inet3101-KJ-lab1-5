...
#define SIZE 4  // Define a fixed size for the array
...
int main() {
    ...
    printf("\n\n");
    printf("\nIndex 0 of array1 starts at: %p", (void*)&array1);
    printf("\nIndex 0 of array2 starts at: %p", (void*)&array2);
    ...
    printf("\n\nCurrent numbers in array1: ");
    for (int i = 0; i < SIZE; i++) {
        printf(" %d ", array1[i]);
    }
    
    printf("\n\nCurrent numbers in array2: ");
    for (int i = 0; i < SIZE; i++) {
        printf(" %d ", array2[i]);
    }
